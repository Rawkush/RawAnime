...
@override
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(title:Text(_categoryList[_bottomSelectedIndex]) ,),
        body: PageView(
        ...
        bottomNavigationBar: CurvedNavigationBar(
          ...
          onTap: (index) {
            setState(() {
              _bottomSelectedIndex=index;
              _pageController.animateToPage(index,duration: Duration(milliseconds: 100),curve: Curves.decelerate);
            });
          },
        ),
      );
